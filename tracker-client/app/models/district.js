...
export default DS.Model.extend({
  ...
  percentVisited: function() {
    ...
    return visits;
  }.property('sisters.[].numberVisited', 'households.[].numberVisited'),
  ...
  sistersLoaded: function() {
    ...
    return allLoaded;
  }.observes('sisters.[].visitsLoaded', 'sisters.[]', 'isloaded'),
  ...
  householdsLoaded: function() {
    ...
    return allLoaded;
  }.observes('households.[].visitsLoaded', 'households.[]', 'isloaded')
});
